...
public class ParticleDespawner : MonoBehaviour {
    ...
    //This script waits x amount seconds after a bullet collides with an object before destroying the game object. This helped with lad a LOT! I now only have about 5 bullets
